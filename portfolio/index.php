        ...
        <div class="row col-8">
            <div class="cardbody2">
                <div class="card text-bg-dark mb-2 text-center">
                    ...
                    <div class="card-body">
                        <img class="lgacquis" src="/image/html.png" alt="html5">
                        <img class="lgacquis" src="/image/css.png" alt="css">
                        <img class="lgacquis" src="/image/javascript.png" alt="javascript">
                        <img class="lgacquis" src="/image/php.png" alt="">
                    </div>
                </div>
        ...
        <div class="row col-8">
            <div class="cardbody2">
                <div class="card text-bg-dark mb-2 text-center">
                    ...
                    <div class="card-body">
                        <img class="lgacquis1" src="/image/image_visual_code_studio.webp" alt="html5">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row col-8">
            <div class="cardbody2">
                <div class="card text-bg-dark mb-2 text-center">
                    ...
                    <div class="card-body">
                        <img class="lgacquis2" src="/image/2.jpg" alt="html5">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="contenue-experience">
        ...
        <div class="row g-0 text-center">
            <div class="col-sm-6 col-md-8">
                ...
                <img class="experience" src="/image/Experience_image_index.jpg" alt="">
                <button id="button-savoirplus" type="button" class="btn btn-outline-dark">
                    <a href="/parcours.html">En Savoir PLus</a>
                </button>
            </div>
...
<div class="container">
    ...
    <div class="row row-cols-9 text-center">
        <div class="col">
            ...
            <div class="col">
                <div id="card-projet" class="card">
                    <img src="/image/portfolio.jpg" class="card-img-top" alt="portfolio">
                    <div class="card-body">
        ...
        <div class="col">
            ...
            <div id="card-projet" class="card">
                <img src="/image/tony_parker.jpg" class="card-img-top" alt="portfolio">
                <div class="card-body">
